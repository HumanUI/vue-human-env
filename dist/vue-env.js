...
/***/ function(module, exports, __webpack_require__) {
	...
	var VueEnv = function () {
	  function VueEnv() {
	    (0, _classCallCheck3.default)(this, VueEnv);

	    this._assign({});
	  }

	  (0, _createClass3.default)(VueEnv, [{
	    key: 'install',
	    value: function install(Vue, env) {
	      this._assign(env);
	      Vue.prototype.$env = this;
	    }
	  }, {
	    key: '_assign',
	    value: function _assign(env) {
	      this.env = (0, _assign3.default)({}, env);
	      return this;
	    }
	  }, {
	    key: 'get',
